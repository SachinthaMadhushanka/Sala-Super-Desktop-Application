          ...
          <div class="card card-primary card-outline">
            ...
            <div class="card-body">
              <table class="table table-striped table-hover " id="table_orderlist">
                ...
                <tbody>
                <?php
                $select = $pdo->prepare("SELECT invoice.*, COUNT(invoice_details.id) as product_count FROM invoice LEFT JOIN invoice_details ON invoice.invoice_id = invoice_details.invoice_id GROUP BY invoice.invoice_id ORDER BY invoice.date_time DESC LIMIT 150");
                $select->execute();
